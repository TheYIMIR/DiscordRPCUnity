...
namespace DiscordRPCUnity
{
    public class DiscordAPI
    {
        ...
        public static void Initialize(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId)
        {
            ...
            staticEventHandlers.readyCallback += DiscordAPI.ReadyCallback;
            staticEventHandlers.disconnectedCallback += DiscordAPI.DisconnectedCallback;
            staticEventHandlers.errorCallback += DiscordAPI.ErrorCallback;
            staticEventHandlers.joinCallback += DiscordAPI.JoinCallback;
            staticEventHandlers.spectateCallback += DiscordAPI.SpectateCallback;
            staticEventHandlers.requestCallback += DiscordAPI.RequestCallback;
